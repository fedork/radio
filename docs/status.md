...
don't know it. Last refreshed **2026-08-27**.  The central correction is that singleton
...
not that every minimal separator reaches such a target.  Padding to `3^K` labelled slots gives an
