...
that its Pascal fixed-absolute-value slice inherits a directed boundary exchange.  Boolean labels
alone do not imply the needed exchange, and laminar supports are
