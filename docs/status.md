...
separator, where the Tight Pascal-Band Lemma gives at least two units of rank gain.  The remaining
step is to prove strict dyadic-band descent before this alternating cut chain can cycle.  Row-count
