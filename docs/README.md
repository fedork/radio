...
| [publication-handover.md](publication-handover.md) | Cold-start entry for the publication track: state, blockers, findings not to rediscover |
| [novelty-audit.md](novelty-audit.md) | Closed prior-art audit, search coverage, verdicts and disclosed limitations |
