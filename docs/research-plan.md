...
`run10/sa193.checkpoint` as it stood at launch (that run has since completed; the frozen input
is stored separately and unaffected), brackets the frontier from the diagonal, and then walks the complete
