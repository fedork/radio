...
| stopped `Sb` walk | run `20260904T221247Z`, `i-03f8c577e8d771049`, `r7iz.xlarge`: `Sb(192:135)@10` with a 15,459,274-fact cache, **MEMORY KILL at 24 GB after 101m33s** (peak 24.58 GB, exit 137), no `WALK` line, root at 8,189/19,410 splits. Final upload ran from the waiting shell as designed; logs, stderr, 142,563-fact checkpoint and instance log are under `sbwalk/20260904T221247Z/`. Instance terminated, as are the m=136 and five-walker attempts. See the [2026-09-05 journal entry](journal.md). |
