...
| active `Sb` walk | run `20260905T171755Z`, `i-012df1398f462964f`, `x2iedn.xlarge` (4 vCPU, 128 GiB, $0.834/h): `Sb(192:135)@10` ascending to 160, `-DRADIO_CACHE_INSERT_NODE_LIMIT=1024ULL`, 110-GiB guard, 3 days. Cache is 15,004,127 facts parsed from three verified raw logs (run10, pareto9 segment, out_k8); all sbwalk harvests excluded as unverifiable. Read with `tools/sbwalk_status.sh [--live]`. Predecessors `20260905T011753Z` (SOLVABLE at m=135, unverifiable), `20260904T221247Z` (memory kill), `20260904T205613Z` and `20260904T202016Z` are all terminated. |
