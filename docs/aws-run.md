...
| active `Sb` walk | run `20260904T202016Z` on on-demand `i-0fc694110b55d76ea`, `r7iz.2xlarge`, us-west-2a; five concurrent `radio_sb_walk` walkers at `k=10`, `n1=192`, `m_start = 136,130,120,110,100`, ascending to `m_end=160`, each capped at 48 h / 10 GiB; warm-started from a 3,753,997-fact cache (sha256 `c95248e5...`). Decides `Sa(11)` via max{m : n(10,m) >= 192}. Durable prefix `sbwalk/20260904T202016Z/`, `STATUS` every ten minutes. |
