...
| completed `Sa` job | `run10` cold `Sa(193)` rerun, on-demand `i-0318c3349a0df835b`, `r7iz.xlarge`, launched 2026-08-31 23:29:01 UTC, **finished 2026-09-04 11:15:15 UTC**: `Sa(193) in 10 = UNSOLVABLE (301127.6 s)`, all 16 roots refuted, `Sa(192)` control 389.9 CPU s, 1.05 GB peak RSS. The host was powered off at 11:16:18 by a leftover shared-host idle-shutdown watcher, 32 s before the watchdog's final archive; the complete log was recovered from the volume on 2026-09-04, verified and archived to release `sa193-cold-run10-2026-09-04`. 83.79 instance-hours at the verified $0.372/h, about $31. Instance stopped; root volume `vol-020083ad3e3df88c4` and snapshot `snap-03f0ad37ce7ec286d` retained. See the [completion record](../evidence/run10_completion_2026-09-04.md). |
